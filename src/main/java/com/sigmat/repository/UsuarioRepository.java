...
public class UsuarioRepository extends BaseRepository<Usuario> {
    ...
    protected Usuario fromDocument(DocumentSnapshot document) {
        ...
        try {
            ...
            if (document.contains("ultimoAcceso")) {
                ...
                String fecha =
                        document.getString("ultimoAcceso");
    ...
    public CompletableFuture<Usuario> findByNombreUsuario(
    ...
    public CompletableFuture<Usuario> authenticate(
            String nombreUsuario,
            String contrasena
    ) {

        logger.info(
                "Intentando autenticacion Firebase para: {}",
                nombreUsuario
        );
